# **Манифест со-творчества: Restaurant Guide Belarus**
...
-   **Кнопка выбора локации** - открывает экран с городами (Минск,
...
3.  **Фокусируйся на MVP** - Мы строим первую версию для проверки
